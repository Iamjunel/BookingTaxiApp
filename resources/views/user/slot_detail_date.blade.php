 ...
 @section('content')
     ...
     <div class="col-md-8 col-sm-12 clearfix p-5">
         <h3 class=""><a href="/user/slot" class="text-dark pr-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-square-fill" viewBox="0 0 16 16">
