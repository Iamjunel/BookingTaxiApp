 ...
 <div class="container">
     <div class="col-md-12 col-sm-12 clearfix">    
         <h3 className="float-left"><a href="/admin" className="text-dark"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-square-fill" viewBox="0 0 16 16">
