            ...
            <div className="row justify-content-center align-items-center m-1 pt-5" style={{ overflow: "auto" }}>
                <div >
                    ...
                    <div className="col-md-12 col-sm-12 clearfix ">
                        <h2 className="float-left"><Link to={'/company'} className="text-dark pr-2"><BsFillArrowLeftSquareFill /></Link><Link to={'/'} className="text-dark pr-1"><FaHome /></Link>Company Name</h2>
                        <Link to={'/company/slot'} className="btn btn-primary float-right">Available Slot</Link>
                        <div className="float-none bg-info">
